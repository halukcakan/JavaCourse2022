...
public class ReusableMethods {
    ...
    public static void bransOgrenciSayisiYazdir(Map<Integer, String> sinifListMap) {
        ...
        for (String each:valuesCollection
            ...
            /*
            ONCESINDE MAP'TE OLAN VALUE DEGERLERI
            COLLLECTION'TA BULUNAN VALUE DEGERLERI SPLIT ILE DATA DATA AYRILARAK
            BIR ARRAY E ATANDI KI
            ARRAYDEKI INDEX DEGERINI VEREREK ISTEDIGIMIZ GIBI DEGISTIRELIM
             */

            brans = valueArr[2];

            /*
            brans'in bransOgrSayiMap'inde key olarak daha onceden
